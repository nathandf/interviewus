	...
	<div id="hero">
		<div id="hero-overlay" class="theme-primary-gradient-transparent">
			<div class="con-cnt-lrg">
				...
				<div class="pad-med">
					<p class="title" style="color: #FFFFFF;">Try it out for <span class="tc-deep-purple">free</span></p>
					<p class="sub-title" style="color: #FFFFFF;">No credit card needed</p>
					<div class="push-t-med">
						<a href="{$HOME}sign-up/" class="button-link bg-real-gold demo-button tc-white"><i class="fas fa-comment-dots push-r-sml"></i>Get started</a>
					</div>
				</div>
				{/if}
